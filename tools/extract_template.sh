...
soft='GLPI - GROUPASSIGNMENT plugin'
version='1.0.0'
...
xgettext *.php */*.php --copyright-holder='GROUPASSIGNMENT Development Team' --package-name='GLPI - GROUPASSIGNMENT plugin' --package-version='1.0.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
